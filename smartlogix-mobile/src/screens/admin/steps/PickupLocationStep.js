    ...
    return (
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.mapContainer}>
                ...
                <Text style={styles.mapHint}>Tap on the map to set pickup location</Text>
            </View>
...
const styles = StyleSheet.create({
    ...
    mapHint: { fontSize: 12, fontFamily: Fonts.medium, color: Colors.textSecondary, textAlign: 'center', marginTop: 8, backgroundColor: '#F0F9FF', padding: 10, borderRadius: 8 },
